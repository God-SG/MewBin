<?php
/**
 * MewBin Ultimate Web Application Firewall (WAF)
 * Maximum protection against all threats - by Spades
 */
...
class MewBinWAF_Ultimate {
    ...
    public function protect() {
        // Anti-console protection - fuck dem hekkers!
        $this->antiConsole();
        ...
        // Input validation - stop that malware!
