...
<nav class="custom-navbar">
    <ul class="nav-left">
        ...
        <li>
            <a href="HOA.php" class="nav-link<?php if(basename($_SERVER['PHP_SELF']) == 'HOA.php') echo ' active'; ?>">
                Hall of Autism
            </a>
        </li>
    </ul>
...
<div id="animatedMessage">Proudly Revamped by Spades!</div>
    ...
    <ul class="nav-right">
        ...
        <li>
            <a href="faq.php" class="nav-link<?php if(basename($_SERVER['PHP_SELF']) == 'faq.php') echo ' active'; ?>">
                FAQ+TOS
            </a>
        </li>
        ...
        <?php if ($username): ?>
            ...
            <li class="notification-bell">
                <a href="messages.php" class="nav-link" aria-label="Messages">
        ...
        <?php else: ?>
            <li>
                <a href="login.php" class="btn btn-sm login-btn">Sign In</a>
            </li>
            <li>
                <a href="register.php" class="btn btn-sm register-btn">Register</a>
            </li>
        <?php endif; ?>
    </ul>
...
#animatedMessage {
  ...
  text-shadow: 
    ...
    0 0 20px #8a2be2,
    0 0 30px #8a2be2,
    0 0 40px #8a2be2; /* Purple glow effect */
...
/* Add overlay when message appears */
...
document.addEventListener('click', function(event) {
    ...
    if (message && message.classList.contains('show-message') && 
        event.target !== logo && !logo.contains(event.target) &&
        event.target !== message && !message.contains(event.target)) {
        message.classList.remove('show-message');
    }
});
</script>